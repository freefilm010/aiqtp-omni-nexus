...
const navItems: NavItem[] = [
  ...
  { title: "IP Registry", href: "/admin/ip-registry", icon: FolderLock },
  { title: "Revenue Automation", href: "/admin/revenue-automation", icon: Zap },
  { title: "NFT Wallet", href: "/admin/nft-wallet", icon: Palette },
  { title: "Master Kill Switch", href: "/admin/kill-switch", icon: Shield },
