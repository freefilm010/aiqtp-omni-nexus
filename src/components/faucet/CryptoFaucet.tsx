...
const FAUCET_TOKENS: FaucetToken[] = [
  ...
  // Rewards under review — no APY/yield promises until token and rewards programs clear legal review.
  { id: 'qtc-stake', symbol: 'QTC', name: 'QTC Rewards Preview', icon: <TrendingUp className="h-5 w-5 text-purple-500" />, claimAmount: 8, claimInterval: 24, available: false, category: 'staking', description: 'Rewards program under compliance review', chain: 'platform', bonus: 'Review', hasValue: false },
  { id: 'aiq-stake', symbol: 'AIQ', name: 'AIQ Rewards Preview', icon: <TrendingUp className="h-5 w-5 text-cyan-500" />, claimAmount: 40, claimInterval: 24, available: false, category: 'staking', description: 'Rewards program under compliance review', chain: 'platform', bonus: 'Review', hasValue: false },
  { id: 'nxs-stake', symbol: 'NXS', name: 'NXS Rewards Preview', icon: <TrendingUp className="h-5 w-5 text-amber-500" />, claimAmount: 75, claimInterval: 24, available: false, category: 'staking', description: 'Rewards program under compliance review', chain: 'platform', bonus: 'Review', hasValue: false },
