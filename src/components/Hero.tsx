...
const Hero = () => {
  ...
  return (
    <section className="relative flex min-h-[70svh] items-center justify-center overflow-hidden bg-[hsl(225,20%,6%)] md:min-h-screen">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-3 pb-4 pt-14 sm:px-6 md:px-8 md:pb-12 md:pt-16 md:ml-11">
        <div className="mb-3 text-center animate-fade-in md:mb-10">
          ...
          <div className="mb-3 flex justify-center animate-slide-up stagger-2 md:mb-6">
            <p className="max-w-xl rounded-xl px-3 py-1.5 text-[11px] leading-snug text-muted-foreground glass-morphism-subtle sm:px-6 sm:py-3 sm:text-sm md:text-base">
          ...
          {/* Primary CTA */}
          <div className="mb-3 flex flex-col items-stretch justify-center gap-2 animate-slide-up stagger-3 sm:flex-row sm:flex-wrap sm:gap-3 md:mb-8">
            <Button
              size="lg"
          ...
          {/* Secondary CTAs */}
          <div className="mb-3 flex items-stretch justify-center gap-2 animate-slide-up stagger-3 sm:mb-6 md:mb-8">
          ...
          <div className="mb-3 flex items-center justify-center gap-3 animate-slide-up stagger-3 md:mb-6">
            <div className="flex items-center gap-1">
              <div className="h-1.5 w-1.5 rounded-full bg-[hsl(162,91%,32%)] animate-pulse" />
              <span className="font-mono text-[9px] text-[hsl(162,91%,32%)]">2,847 online</span>
            </div>
            <span className="text-[hsl(222,14%,25%)]">|</span>
            <span className="font-mono text-[9px] text-muted-foreground">$14.2M+ today</span>
          </div>
        </div>

        {/* Mini charts — hidden on very small mobile to save scroll */}
        <div className="hidden sm:grid bento-grid grid-cols-2 lg:grid-cols-3 animate-scale-in stagger-4 mb-4 md:mb-8">
        ...
        <div className="mb-3 flex flex-wrap justify-center gap-1 animate-slide-up stagger-5 md:mb-8 md:gap-2">
          <Badge variant="outline" className="px-2 py-0.5 font-mono text-[8px] text-muted-foreground glass-morphism-subtle micro-hover border-[hsl(270,91%,65%,0.2)] md:px-4 md:py-1.5 md:text-[10px]">
            <Shield className="w-2.5 h-2.5 mr-0.5 text-[hsl(270,91%,65%)] md:w-3 md:h-3 md:mr-1" />
            Quantum
          </Badge>
          <Badge variant="outline" className="px-2 py-0.5 font-mono text-[8px] text-muted-foreground glass-morphism-subtle micro-hover border-[hsl(224,100%,58%,0.2)] md:px-4 md:py-1.5 md:text-[10px]">
            <Globe className="w-2.5 h-2.5 mr-0.5 text-[hsl(224,100%,58%)] md:w-3 md:h-3 md:mr-1" />
            Global
          </Badge>
          <Badge variant="outline" className="px-2 py-0.5 font-mono text-[8px] text-muted-foreground glass-morphism-subtle micro-hover border-[hsl(43,96%,56%,0.2)] md:px-4 md:py-1.5 md:text-[10px]">
            <Zap className="w-2.5 h-2.5 mr-0.5 text-[hsl(43,96%,56%)] md:w-3 md:h-3 md:mr-1" />
            Lightning
          </Badge>
          <Badge variant="outline" className="px-2 py-0.5 font-mono text-[8px] text-muted-foreground glass-morphism-subtle micro-hover border-[hsl(162,91%,32%,0.2)] md:px-4 md:py-1.5 md:text-[10px]">
            <Bot className="w-2.5 h-2.5 mr-0.5 text-[hsl(162,91%,32%)] md:w-3 md:h-3 md:mr-1" />
            AI Bots™
          </Badge>
        </div>
        ...
        <div className="grid grid-cols-2 gap-1.5 text-center animate-slide-up stagger-6 lg:grid-cols-4 lg:gap-4">
          <div className="rounded-xl px-2 py-1.5 glass-morphism-subtle micro-hover md:px-6 md:py-3">
            ...
            <div className="font-mono text-[7px] uppercase tracking-wider text-muted-foreground md:text-[9px]">Crypto · Stocks</div>
          </div>
          <div className="rounded-xl px-2 py-1.5 glass-morphism-subtle micro-hover md:px-6 md:py-3">
            <div className="font-mono text-sm font-bold text-[hsl(162,91%,32%)] md:text-xl">Zero Fees</div>
            <div className="font-mono text-[7px] uppercase tracking-wider text-muted-foreground md:text-[9px]">No Subs</div>
          </div>
          <div className="rounded-xl px-2 py-1.5 glass-morphism-subtle micro-hover md:px-6 md:py-3">
            <div className="font-mono text-sm font-bold text-[hsl(270,91%,65%)] md:text-xl">AI-Powered</div>
            <div className="font-mono text-[7px] uppercase tracking-wider text-muted-foreground md:text-[9px]">ML Signals</div>
          </div>
          <div className="rounded-xl px-2 py-1.5 glass-morphism-subtle micro-hover md:px-6 md:py-3">
            <div className="font-mono text-sm font-bold text-[hsl(224,100%,58%)] md:text-xl">Quantum-Safe</div>
            <div className="font-mono text-[7px] uppercase tracking-wider text-muted-foreground md:text-[9px]">PQ Crypto</div>
          </div>
        </div>
      </div>
